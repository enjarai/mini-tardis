...
public interface AppView {
    ...
    default void drawBackground(DrawableCanvas canvas) {
     ...
     */
    boolean onClick(ServerPlayerEntity player, ClickType type, int x, int y);
