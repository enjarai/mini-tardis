...
public interface CanvasFont {
     ...
     */
    default void drawText(DrawableCanvas canvas, String text, int x, int y, double size, short color) {
        int posX = 0;
        int posY = 0;
     ...
     * @return width of glyph
     */
    int drawGlyph(DrawableCanvas canvas, int character, int x, int y, double size, int offset, short color);
